    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-rows-[auto_auto_1fr] gap-6 h-full">
            ...
            <div className="bg-white border-4 border-slate-800 rounded-xl p-6 shadow-[6px_6px_0px_0px_rgba(30,41,59,1)] flex flex-col justify-between">
                ...
                <div className="mt-6 pt-3 border-t-4 border-slate-800">
                    <ResultRow label="월 지급총액" value={result.monthlyTotal} isTotal={true} />
                </div>
            </div>

            {/* 2. Deductions (Top Right) */}
            <div className="bg-red-50 border-4 border-red-800 rounded-xl p-6 shadow-[6px_6px_0px_0px_rgba(153,27,27,0.3)] flex flex-col justify-between">
                ...
                <div className="mt-6 pt-3 border-t-2 border-red-200 flex justify-between items-center text-red-900 font-bold">
                    <span className="text-base">공제 합계</span>
                    <span className="text-xl">- {formatMoney(result.deductions.total)}</span>
                </div>
            </div>

            {/* 3. Net Pay (Middle Span) */}
            <div className="md:col-span-2 bg-blue-50 border-4 border-blue-600 rounded-xl p-6 shadow-[6px_6px_0px_0px_rgba(37,99,235,0.3)] flex items-center justify-between">
            ...
            <div className="md:col-span-2 bg-yellow-50 border-4 border-yellow-800 rounded-xl p-6 shadow-[6px_6px_0px_0px_rgba(161,98,7,0.3)] h-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="flex flex-col justify-end space-y-3 md:border-l-2 md:border-yellow-200 md:pl-8">
